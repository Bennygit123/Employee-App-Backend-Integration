...
mongoose.connect("mongodb+srv://benisamprakash:benisamprakash@cluster0.i3g9dq4.mongodb.net/employeeDB retryWrites=true&w=majority&appName=Cluster0";
{
...
app.delete("/api/employeelist/:id", async (req, res) => {
     try{
        const deletedEmployee = await Employee.findIdAndDelete(req.params.id);
        if (!deletedEmployee){
             return res.status(404).json({error: "Employee not found" });
            }
